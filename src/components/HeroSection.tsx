...
const HeroSection = () => {
  return (
    <section className="container relative flex flex-col justify-center items-center min-h-[88vh]">
      <h1 className="text-8xl leading-snug transform -translate-y-10">
      ...
      <p className="mt-6  font-sans w-[733px] text-center transform -translate-y-10">
