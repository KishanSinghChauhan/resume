...
const Project: FC<IProjectProps> = ({
  ...
  return (
    <>
      ...
      >
        <div
          className="relative w-full h-[520px] border-[10px] overflow-hidden group inline-block cursor-pointer"
          style={{ borderColor }}
        >
          {comingSoon && (
            <>
              <div className="absolute top-0 left-0 w-full h-full backdrop-blur-sm z-[9] bg-transparent" />
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 text-2xl h-14 rounded-full flex items-center px-8 -translate-y-1/2 z-10 bg-[#E0CA3C] text-[#000F08]">
                Coming Soon
              </div>
            </>
          )}
        ...
        <div className="mt-6 flex group items-center gap-2 w-max cursor-pointer">
